    ...
    private void printEndpointStates() throws IOException
    {
        ...
        executor2.scheduleWithFixedDelay(new Runnable(){
        	public void run(){
            	...
            	Gossiper.instance.addLocalApplicationState(ApplicationState.LOAD,String.valueOf((System.currentTimeMillis()/1000)));
//            	Gossiper.instance.addLocalApplicationState(ApplicationState.WEIGHT,VersionedValueFactory.instance.weight(50));
    ...
    public static void main(String[] args) throws IOException, InterruptedException
    {
		...
		GossiperDescriptor.init(new GossipConfig("localhost:9001","localhost:9001,localhost:9002"));
		//TODO
